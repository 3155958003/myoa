...
<div id="MainArea">
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
            <s:a action="departmentAction_saveUI?parentId=%{parentId}"><img src="${pageContext.request.contextPath}/style/images/createNew.png" /></s:a>
           <%--  <s:if test="#parent != null"> --%>
				<s:a action="departmentAction_list?parentId=%{#parent.parent.id}"><img src="${pageContext.request.contextPath}/style/blue/images/button/ReturnToPrevLevel.png" /></s:a>
            <%-- </s:if> --%>
        </div>
    </div>
</div>
