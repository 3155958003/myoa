...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> ${topic.title }
        </div>
...
<div id="MainArea">
	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%">
			...
			<s:a action="forumAction_list.action">论坛</s:a>
			<font class="MenuPoint"> &gt; </font>
			...
			<table border="0" cellspacing="1" width="98%" cellpadding="5" class="TableStyle">
				<tr height="30" class="Tint">
					...
					<td class="no_color_bg">
						<input type="text" name="title" class="InputStyle" value="${topic.title }" style="width:90%"/>
					</td>
				</tr>
				<tr height="30" class="Tint">
