...
<div id=MainArea>
    <s:form action="flowAction_approve">
    	<s:hidden name="approval"></s:hidden>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                ...
                <s:if test="%{#comes.size>1}">
                  <tr>
                        <td>请选择下一步</td>
                        <td><s:select list="#comes" name="outcome"></s:select></td>
                   </tr>
				</s:if>
                </table>
            </div>
        ...
        <div id="InputDetailBar" style="float:none">
			...
			<input type="image" onclick="document.forms[0].approval.value='true'" src="${pageContext.request.contextPath}/style/blue/images/button/agree.png"/>
