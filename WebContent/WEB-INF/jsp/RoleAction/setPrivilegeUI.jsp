...
<div id=MainArea>
    ...
    <form id="roleAction_setPrivilege" name="roleAction_setPrivilege" action="${pageContext.request.contextPath}/roleAction_setPrivilege.action" method="post">
    	<input type="hidden" name="id" value="${role.id }" id="roleAction_setPrivilege_id"/>
