...
public class Installer {
	...
	public void install() {
		...
		session.save(new Privilege("岗位添加", "roleAction_save", null, menu1));
		...
		session.save(new Privilege("部门添加", "departmentAction_save", null, menu2));
		...
		session.save(new Privilege("用户添加", "userAction_save", null, menu3));
